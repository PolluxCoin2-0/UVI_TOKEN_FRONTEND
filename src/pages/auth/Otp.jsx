  ...
  return (
    <div className="bg-black flex justify-center relative w-full h-screen px-6 md:px-0">
      ...
      <div className="bg-black rounded-2xl shadow-custom shadow-gray-800 w-full md:w-[60%] lg:w-[50%] xl:w-[36%] h-[55%] md:h-[60%] lg:h-[65%] mt-36 flex flex-col items-center relative z-10">
        <p className="font-semibold text-xl md:text-3xl mb-8 text-center text-white  pt-10 lg:pt-20 xl:pt-14 2xl:pt-20 md:pt-16" >Enter Code</p>
        ...
        <p className="text-white px-3 md:px-24 lg:px-32 xl:px-32 2xl:px-52 font-semibold text-center text-lg mt-5">A one time authentication code has been 
        sent to E-mail</p>
        ...
        className="bg-white px-20 md:px-36 rounded-lg py-2  md:py-3 mt-8 text-md md:text-lg font-bold">
            ...
            <p className="text-white text-lg md:text-xl ml-2"><ExpiryOtpTimer /> </p>
            ...
            <p>
                <button
                type="button"
                className="text-[#FFB800] text-lg md:text-xl">Resend Code</button>
            </p>
            </div>
